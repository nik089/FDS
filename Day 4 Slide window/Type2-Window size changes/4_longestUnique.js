...
function longestUnique(s) {
  ...
  const substring = s.slice(bestStart, bestStart + max);
  console.log("Longest unique substring:", substring);

  return max;
}

console.log("Length:", longestUnique("abcabcbb"));
